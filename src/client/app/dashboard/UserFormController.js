(function() {
  ...
  UserFormController.$inject = ['$rootScope', '$scope', '$location', '$cookies', 'UserService', 'AuthenticationService', 'Upload', '$http'];
  function UserFormController($rootScope, $scope, $location, $cookies, UserService, AuthenticationService, Upload, $http) {
    var vm = this;
